...
const (
	...
	rootpw     = "38169888711E3FABEE9088CFF3F46EFEE3408A7509FE296CEE600339E22584F0"
...
func (s *ServerSuite) SetUpTest(c *C) {
    ...
    if exists == false {
        err = s.server.DBCreate(testdbname, o.DatabaseTypes.GRAPH, o.StorageTypes.LOCAL)
        c.Assert(err, IsNil)
    }
}
...
func (s *DatabaseSuite) SetUpSuite(c *C) {
    ...
    err = server.DBCreate(testdbname, o.DataClusterTypes.PHYSICAL, o.StorageTypes.LOCAL)
    c.Assert(err, IsNil)
